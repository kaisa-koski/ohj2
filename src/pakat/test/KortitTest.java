 ...
 * @version 2021.03.16 12:45:40 // Generated by ComTest
 *
 */
...
public class KortitTest {
  ...
  /** testLisaa31 */
  @Test
  public void testLisaa31() {    // Kortit: 31
    ...
    kortit.lisaa(jace1); assertEquals("From: Kortit line: 46", 6, kortit.getLkm()); 
    kortit.lisaa(jace1); assertEquals("From: Kortit line: 47", 7, kortit.getLkm()); 
    kortit.lisaa(jace1); assertEquals("From: Kortit line: 48", 8, kortit.getLkm()); 
    kortit.lisaa(jace1); assertEquals("From: Kortit line: 49", 9, kortit.getLkm()); 
    kortit.lisaa(jace1); assertEquals("From: Kortit line: 50", 10, kortit.getLkm()); 
    kortit.lisaa(jace1); assertEquals("From: Kortit line: 51", 11, kortit.getLkm()); 
  } // Generated by ComTest END
}